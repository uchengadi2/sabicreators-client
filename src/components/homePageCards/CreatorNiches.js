...
export default function CreatorNiches(props) {
...
//           {props.niches.map((creator, index) => (
//             <AllCreatorsOnList
//             id={creator}
    ...
    <>
      {matchesMDUp ? (
        <Grid container direction="column">
            <Grid item><Typography>Just testing stuff</Typography></Grid>
            <Grid item><Typography>Just testing stuff22222</Typography></Grid>
        </Grid>
