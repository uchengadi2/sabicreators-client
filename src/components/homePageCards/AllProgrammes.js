...
export default function AllProgrammes(props) {
  ...
  let imageUrl = "";
  if (product) {
    imageUrl = `${baseURL}/images/programmes/${props.image}`;
  }
            ...
            <Grid item style={{ width: "46.19%", border: "1px dotted grey" }}>
              <CardContent>
                ...
                <Typography
                  ...
                  component="p"
                >
                  {Str(props.description).limit(200, "...").get()}
                </Typography>
                {/* <Typography
                  variant="h4"
                  color="textSecondary"
                ...
                <Typography>
                  <span style={{ fontSize: 14, marginLeft: 10 }}>
                    <strong>Average Pass Grde:</strong>
                    <span>{props.averageNextChampGradePoint} </span>
                  </span>
                </Typography>
                <Typography>
                  <span style={{ fontSize: 14, marginLeft: 10 }}>
