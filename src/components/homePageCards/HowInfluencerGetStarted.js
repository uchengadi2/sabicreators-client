...
export default function HowInfluencerGetStarted() {
  ...
  const theProcess = "* **Sign Up as a Creator**: Create your account and complete your profile with the required details.\n\n* **Showcase Your Work**: Upload sample projects to strengthen your profile and stand out to brands.\n\n";
                    ...
                    >
                     ...
                     {/* <Typography style={{marginTop:0, padding: 0,fontSize:17}}>
                      ...
                      <Typography style={{marginTop:10, fontSize:15}}>
                            <ReactMarkdown>Joining as a creator is quick and simple—just follow these steps:</ReactMarkdown>
                      </Typography>
                      <Typography style={{marginTop:30, fontSize:15}}>
                          <ReactMarkdown>{theProcess}</ReactMarkdown>
                    </Typography>
                      <Typography style={{marginTop:30, fontSize:15}}>
                          <em><ReactMarkdown>Start today and unlock opportunities to collaborate with top brands.</ReactMarkdown></em>
                    </Typography>
                     {/* <Button 
                        variant="contained" 
                        color="secondary" 
