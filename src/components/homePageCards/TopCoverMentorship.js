...
export default function TopCoverMentorship() {
  ...
  const instructorSection = () => {
    ...
    return <React.Fragment>Become a Mentor</React.Fragment>;
  };
            ...
            <Grid item style={{ width: "48%", border: "1px dotted grey" }}>
              <CardContent disableRipple>
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    At **Nextchamp**, we believe that guidance and mentorship
                    are essential for success in both academic and professional
                    journeys. That’s why we provide expert-led mentorship to
                    professionals and students across all tiers of education,
                    equipping them with the knowledge, skills, and confidence to
                    excel in their respective fields.
                  </ReactMarkdown>
                  <span style={{ marginLeft: -7 }}>
                    Our mentorship programs are tailored to meet the unique
                    needs of:
                  </span>
                  <ReactMarkdown>
                    * **Professionals** – Whether you are looking to upskill,
                    switch careers, or advance in your current role, our
                    industry experts provide personalized guidance, helping you
                    navigate challenges, master new competencies, and stay ahead
            ...
            >
              <Grid item>
                <CardContent disableRipple>
                  <Typography variant="h5" color="textSecondary" component="p">
                    <ReactMarkdown>
                      * **Students** – From high school to university and
                      beyond, we support students at every stage of their
                      education. Our mentors offer career advice, academic
                      support, and skill-building opportunities to ensure
                  ...
                  <Typography variant="h5" color="textSecondary" component="p">
                    <ReactMarkdown>
                      With real-world expertise and hands-on training, we
                      empower learners to achieve their goals. Join Nextchamp
