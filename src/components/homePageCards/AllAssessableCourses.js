...
import CourseHomeAndPrivateInfo from "./CourseHomeAndPrivateInfo";
import CourseMentorshipInfo from "./CourseMentorshipInfo";
import CourseAssessmentInfo from "./CourseAssessmentInfo";
...
export default function AllAssessableCourses(props) {
