                ...
                <Grid sm item className={classes.heroTextContainer}>
                  {matchesMD ? (
                    ...
                    >
                      ...
                      >
                        {" "}
                      Collaborate with skilled influencers, video producers, and jingle creators to <br />
                      </span>{" "}
                      <span style={{ marginLeft: matchesSM ? 20 : 60 }}>
                      craft high-quality content that elevates your brand, 
                      </span>
                      <br />
                    ...
                    <Typography variant={matchesSM ? "subtitle2" : "h2"} align="left" style={{ marginTop: "2rem" }}><strong style={{marginLeft:matchesSM ? 10 : 50}}>Create Impactful Campaigns with Top Creators</strong></Typography>
                    </>
                  ) : (
                    <>
                    <Typography
                    ...
                    >
                      ...
                      >
                        {" "}
                      Collaborate with skilled influencers, video producers, <br />
                      </span>{" "}
                      <span style={{ marginLeft: matchesSM ? 20 : 60 }}>
                      and jingle creators to craft high-quality content 
                      </span>
                      <br />
                      <span style={{ marginLeft: matchesSM ? 30 : 60 }}>
                       that elevates your brand, engages your audience, 
                      </span>
                      <br />
                      ...
                      {/* <span style={{ marginLeft: matchesSM ? 50 : 140 }}>
                       ...
                       <Typography variant={matchesSM ? "subtitle2" : "h5"} align="center" style={{ marginTop: "2rem" }}><strong style={{marginLeft:matchesSM ? 10 : 110}}>Create Impactful Campaigns with Top Creators</strong></Typography>
                    </>
