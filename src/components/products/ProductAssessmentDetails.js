...
import ProductMentorshipDetailsCard from "./ProductMentorshipDetailsCard";
import ProductAssessmentDetailsCard from "./ProductAssessmentDetailsCard";
...
function ProductAssessmentDetails(props) {
...
export default ProductAssessmentDetails;
