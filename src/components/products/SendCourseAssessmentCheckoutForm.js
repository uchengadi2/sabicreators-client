...
function SendCourseAssessmentCheckoutForm(props) {
  ...
  const buttonContent = () => {
    return <React.Fragment> Take a Mock</React.Fragment>;
  };

  const hireAssessorButtonContent = () => {
    return <React.Fragment>Hire An Assessor</React.Fragment>;
  };

  const takeObjAssessmentButtonContent = () => {
    return <React.Fragment>Take Assessment(MCQ)</React.Fragment>;
  };
  const takeAssessmentButtonContent = () => {
    return <React.Fragment>Take Assessment</React.Fragment>;
  };
  ...
  return (
    <form id="sendCourseToCheckoutForm">
      ...
      >
        ...
        <Button
          variant="text"
          className={classes.submitTakeMcqAssessmentButton}
        ...
        takeObjAssessmentButtonContent()
          )}
        </Button>
        <Button
          variant="text"
          className={classes.submitTakeAssessmentButton}
          onClick={props.handleSubmit(onSubmitToCart)}
          disabled={true}
        >
          {isLoading ? (
        ...
        takeAssessmentButtonContent()
          )}
        </Button>
        <Button
          variant="text"
          className={classes.submitHireAssessorButton}
          onClick={props.handleSubmit(onSubmitToCart)}
          disabled={true}
        >
          {isLoading ? (
            ...
            hireAssessorButtonContent()
          )}
        </Button>
        <Typography style={{fontSize:11,fontWeight:700,marginTop:40,marginLeft:30}}>MCQ: Multiple Choice Questions</Typography>
      </Box>
    </form>
  );
}
