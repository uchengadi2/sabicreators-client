...
import SendCourseNuggetToCheckoutForm from "./SendCourseNuggetToCheckoutForm";
...
export default function ProductNuggetDetailCard(props) {
              ...
              <Box>
                ...
                <Typography variant="h4" style={{ marginTop: 10 }}>
                  ...
                  {price
                    ...
                    : 0}
                  <span style={{ fontSize: 12, marginLeft: 0 }}>/ month</span>
                </Typography>
                ...
                >
                  <span style={{ marginRight: 20 }}>
                    {" "}
                    <strong>
                      Is Life Time Access To This Nugget Allowed?:
                    </strong>
                  </span>
