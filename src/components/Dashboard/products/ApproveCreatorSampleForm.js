...
function ApproveCreatorSampleForm(props) {
      ...
      const editForm = async () => {
        ...
        if (response.data.status === "success") {
          props.handleSuccessfulDeletedItemSnackbar(
            `This Creator Sample is Approved}!!!`
          );
  ...
  return (
    <>
      ...
      >
        <AlertTitle>Creator Sample Approval</AlertTitle>
...
export default ApproveCreatorSampleForm;
