...
import UnapproveCreatorSampleForm from "./UnapproveCreatorSampleForm";
...
function CreatorApprovedSamples(props) {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const response = await api.get(`/samples`,{params:{isAllowedOnThePlatform:true}});
      ...
      <Grid container spacing={1} direction="column">
        <Grid item xs>
          <Grid container spacing={2}>
            <Grid item xs={8.5}>
              {/* <Item>xs=8</Item> */}
              <Typography variant="h4">Creators' Approved Samples</Typography>
            </Grid>
            <Grid item xs={3.5}>
              <div>
...
export default CreatorApprovedSamples;
