...
function OrdersInReview(props) {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const response = await api.get(`/orders`, {params:{status:"creative-in-review",creator:props.creatorId}});
      ...
      workingData.map((order) => {
        allData.push({
          ...
          creorderedCreativePricePerUnittor:order.orderedCreativePricePerUnit,
      ...
      <Grid container spacing={1} direction="column">
        <Grid item xs>
          <Grid container spacing={2}>
            <Grid item xs={10.2}>
              {/* <Item>xs=8</Item> */}
              <Typography variant="h4">Orders In Review</Typography>
            </Grid>
            <Grid item xs={1.8}>
              <div>
