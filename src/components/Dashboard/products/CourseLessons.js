...
import CourseLessonDeleteForm from "./CourseLessonDeleteForm";
import CourseLessonEditForm from "./CourseLessonEditForm";
...
function CourseLessons(props) {
  ...
  const renderDataGrid = () => {
    ...
    courseLessonsList.map((course, index) => {
      ...
      <Grid container spacing={1} direction="column">
        <Grid item xs>
          <Grid container spacing={2}>
            <Grid item xs={9.3}>
              {/* <Item>xs=8</Item> */}
              <Typography variant="h4">Course Lessons</Typography>
            </Grid>
            <Grid item xs={2.7}>
              <div>
