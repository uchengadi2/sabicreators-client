...
function ProjectsInReview(props) {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const response = await api.get(`/projects`, {params:{status:"in-review"}});
      ...
      <Grid container spacing={1} direction="column">
        <Grid item xs>
          <Grid container spacing={2}>
            <Grid item xs={11}>
              {/* <Item>xs=8</Item> */}
              <Typography variant="h4">Projects In Review</Typography>
            </Grid>
            <Grid item xs={1}>
              <div>
...
export default ProjectsInReview;
