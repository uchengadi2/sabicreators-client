    ...
    const fetchData = async () => {
      ...
      workingData.map((instructor) => {
        allData.push({
          ...
          refNumber: instructor.refNumber,
          ...
          dateCreated: instructor.dateCreated,
          linkedInProfile: instructor.linkedInProfile,
          gitHubProfile: instructor.gitHubProfile,
          bio: instructor.bio,
        });
      });
  ...
  const renderDataGrid = () => {
    ...
    instructorsList.map((instructor, index) => {
      let row = {
        ...
        gitHubProfile: instructor.gitHubProfile,
        bio: instructor.bio,
        userId: instructor.user.length === 1 ? instructor.user[0].id : " ",
      };
      rows.push(row);
    });
