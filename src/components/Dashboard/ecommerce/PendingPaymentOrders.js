...
import GetPayOutDetails from "./GetPayOutDetails";
import ConfirmPayoutToCreator from "./ConfirmPayoutToCreator";
...
function PendingPaymentOrders(props) {
      ...
      <Grid container spacing={1} direction="column">
        <Grid item xs>
          <Grid container spacing={2}>
            <Grid item xs={7.2}>
              {/* <Item>xs=8</Item> */}
              <Typography variant="h4">Pending Payout Orders</Typography>
            </Grid>
            <Grid item xs={4.8}>
              <div>
