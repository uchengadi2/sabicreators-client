    ...
    <form id="viewOrderDetails">
      ...
      >
        ...
        <Field
          ...
          id="brandName"
          name="brandName"
          defaultValue={params[0].brand[0].name}
          type="text"
        ...
        <Field
          ...
          defaultValue={params[0].brand[0].brandContactEmailAddress}
          type="text"
        ...
        <Field
          ...
          defaultValue={params[0].brand[0].brandContactPhoneNumber}
          type="text"
        ...
        <Field
          ...
          id="brandCountry"
          name="brandCountry"
          defaultValue={params[0].brand[0].country[0].name}
          type="text"
