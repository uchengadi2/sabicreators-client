...
function ViewMarkedCompletedOrders(props) {
const {params, token, userId} = props;
  ...
  console.log("markForCompletionDate:", params[0].markForCompletionDate);

  

  return (
    <form id="viewMarkedCompletedOrders">
      <Box
        // component="form"
        // id="categoryForm"
        // onSubmit={onSubmit}
      ...
      >
        ...
        <Field
          ...
          id="brandName"
          name="brandName"
          defaultValue={params[0].brand ? params[0].brand[0].name : ""}
          type="text"
        ...
        <Field
          ...
          defaultValue={params[0].brand ? params[0].brand[0].brandContactEmailAddress: ""}
          type="text"
          helperText="Brand Contact Email Address"
          readOnly={true}
          component={renderNameField}
        ...
        <Field
          ...
          defaultValue={params[0].brand ? params[0].brand[0].brandContactPhoneNumber: ""}
          type="text"
          helperText="Brand Contact Phone Number"
          readOnly={true}
          component={renderNameField}
        ...
        <Field
          label=""
          id="markForCompletionBy"
          name="markForCompletionBy"
          defaultValue={params[0].markForCompletionBy ? params[0].markForCompletionBy.name : ""}
          type="text"
          helperText="Marked By"
          readOnly={true}
          component={renderNameField}
        ...
        />
         <Field
          label=""
          id="markForCompletionRole"
          name="markForCompletionRole"
          defaultValue={params[0].markForCompletionBy ? params[0].markForCompletionBy.role: ""}
          type="text"
          helperText="Marked User Role"
          readOnly={true}
          component={renderNameField}
        ...
        />
         <Field
          label=""
          id="markedByIdentity"
          name="markedByIdentity"
          defaultValue={params[0].markedByIdentity}
          type="text"
          helperText="Marked User Identity"
          readOnly={true}
          component={renderNameField}
        ...
        <Field
          label=""
          id="markForCompletionDate"
          name="markForCompletionDate"
          defaultValue={params[0].markForCompletionDate}
          type="text"
          helperText="Date Marked For Completion"
          readOnly={true}
          component={renderNameField}
...
export default reduxForm({
  form: "viewMarkedCompletedOrders",
